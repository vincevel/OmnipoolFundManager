...
class ManyChatControllerManual extends Controller
{
    /**
    ...
    public function setOrg($org){
    	...
    	switch (strtoupper(trim($org))){
				...
				case "DEPOSIT TO WALLET":	
					...
					break;
				case "MARZAN 1":	
					$inputs["investment_type"] = "MARZAN 1";
					break;
				
				case "MADDELA 1":	
					$inputs["investment_type"] = "MADDELA 1";
					break;
    ...
    public function manual3(){
        ...
        $email = "maria.c.m.bernal@gmail.com";
    ...
    public function manual2(){
        ...
        */
        ...
        $isValidOrg = $this->setOrg2($item->sri_organization);
        ...
        */
        ...
        $receiver_test = "vincentvelasco1232019@gmail.com";
