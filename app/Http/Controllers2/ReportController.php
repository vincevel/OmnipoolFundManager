...
class ReportController extends Controller
{
    ...
    public function queryMonthlyCombined($org){
        ...
        return $this->queryMonthlyDivCombined($data,$count,$org);
     
        //return array($data,$count,$org);   
    }
    
    public function queryMonthlyDivCombined($data,$count,$org){
        
    
        if ($org == "SEDPI"){

            $monthly = DB::table('monthly3')->where([])
            ->whereIn('investment_type',array("SEDPI","Class B","Class D","Class E"))->get();
     ...
     public function queryMonthlyDiv($org){
    ...
    public function queryYearlyCombined($org){
        ...
        return $this->queryYearlyDivCombined($data,$count,$org);
     
        //return array($data,$count,$org);   
    }
    
    public function queryYearlyDiv($org){
        
        if ($org == "SEDPI"){

            $yearly = DB::table('yearly3')->where([])
            ->whereIn('investment_type',array("SEDPI","Class B","Class D","Class E"))->get();
    ...
    public function queryYearlyDivCombined($data,$count,$org){
    ...
    public function queryMonthlyTotalCombined(){
        ...
        return $this->queryMonthlyTotalDivCombined($data,$count,$org,$growth,$growthCount);
        //return $this->queryMonthlyTotalDiv();
        //return array($data,$count,$org,$growth,$growthCount);   
    }
    
    
    
    public function queryMonthlyTotalDivCombined($data,$count,$org,$growth,$growthCount){
        
        $monthly = DB::table('monthly4')->where([
                ...
                if ($j<$startdate[0] && $i==$startdate[1] ){
                    ...
                    if (!isset($data[$i][$j])){
                        ...
                        //initialize at first iteration
                            ...
                            $growth[$i][$j] = ($data[$i][$j] - $prev) / $prev;
                            $growthCount[$i][$j] = ($count[$i][$j] - $prevCount) / $prevCount;
    ...
    public function queryMonthlyTotalDiv(){
    ...
    public function queryYearlyTotalCombined(){
        ...
        return $this->queryYearlyTotalCombinedDiv($data,$count,$org,$growth,$growthCount);   
        
        //return array($data,$count,$org,$growth,$growthCount);   
    }
    
    public function queryYearlyTotalCombinedDiv($data,$count,$org,$growth,$growthCount){
        
        $yearly = DB::table('yearly4')->where([
        ...
        for ($i=$startdate[1];$i<$enddate[1]+1;$i++){
        	...
        	if (!isset($data[$i])){
             	...
             	if ($k == 0){
                  	...
                  	$growth[$i] = ($data[$i] - $prev) / $prev;
                    $growthCount[$i] = ($count[$i] - $prevCount) / $prevCount;
    ...
    public function queryYearlyTotalDiv(){
    ...
    public function summaryMonthly(){
        ...
        /*
        $first = $this->displayMonthly($this->queryMonthly($orgs1));
        $second = $this->displayMonthly($this->queryMonthlyDiv($orgs1));
        //$first = $this->queryMonthly($orgs1);
        $this->displayMonthly($this->queryMonthlyCombined($orgs1));
        */
        
        //foreach ($first[0] as $items){
        ...
        foreach ($orgs as $org){
            ...
            //$this->displayMonthly($this->queryMonthlyDiv($org));
            $this->displayMonthly($this->queryMonthlyCombined($org));
            
        }
        //$this->displayMonthly($this->queryMonthlyTotal());
        //$this->displayMonthly($this->queryMonthlyTotalDiv());
        $this->displayMonthly($this->queryMonthlyTotalCombined());
    ...
    public function summaryYearly(){
        ...
        foreach ($orgs as $org){
            ...
            //$this->displayYearly($this->queryYearlyDiv($org));
            $this->displayYearly($this->queryYearlyCombined($org));
        }
        //$this->displayYearly($this->queryYearlyTotal());
        //$this->displayYearly($this->queryYearlyTotalDiv());
        $this->displayYearly($this->queryYearlyTotalCombined());
