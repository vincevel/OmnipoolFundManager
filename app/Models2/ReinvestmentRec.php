...
class ReinvestmentRec extends Model
{
    public $fullName;
    ...
    function __construct($fullName,$sriDepositDate,$sriDepositAmount,$sriOrganization,$lastInteraction,$email) {
        ...
        $this->sriDepositDate = $sriDepositDate;
        $this->sriDepositAmount = str_replace( ',', '', $sriDepositAmount);
        $this->sriOrganization = $sriOrganization;
    ...
    public function process($denomination = 1){
        
          //CHECK IF BELOW 1 Peso - denomination
            if ($this->sriDepositAmount < $denomination){
                $this->isInvalid = true;
    ...
    public function formatOrg($org){
        ...
        return strtoupper(str_replace(" ","",$org));
    ...
    public function checkIfPagibig($org){
    ...
    public function storeReinvest($user,$amount,$date,$org)
    {
            ...
            $isPI = $this->checkIfPagibig($this->fOrg);
             ...
             //Wallet Transaction
                        ...
                        if ($isPI){
                            $transaction2->remarks = "Reinvested to P1";
                        } else {
                            $transaction2->remarks = "Reinvested to $this->fOrg";
                        }
                        ...
                        if ($isPI){
                            $transaction1->investment_type = "P1";
                        } else {
