...
<body>
  ...
  <h2 id="header_184" class="form-header" data-component="header">
              ...
              View Transactions - BLADE 5 - VUEJS BLADE VERSION C RENTAL
   ...
   var app2 = new Vue({
    ...
    created() {
        ...
        */
        ...
        axios.get("/sri/api/transactions/getAllDividendsRentals",{
              //firstName: this.count
              org: this.lorg
          }) 
          .then(results => {
    ...
    methods: {
        ...
        updateEligible(v) {
          ...
          //u_data.item
           ...
           axios.post("/sri/api/dividendupdate/updateeligiblerental",{
        ...
        updateEligibleAmount(v) {
          ...
          //u_data.item
           ...
           axios.post("/sri/api/dividendupdate/updateeligibleamountrental",{
              t_id: v.transaction_id,
              e_amount: v.e_amount
          }).then(results => {
            console.log(results)
   ...
   var app5 = new Vue({
    ...
    methods: {
       updaterbalance(v) {
          //console.log(v.item.amount)
          //console.log(v)
            axios.post("/sri/api/dividendupdate/updaterbalancerental",{
              //firstName: this.count
              org: this.lorg
            }) 
            .then(results => {
