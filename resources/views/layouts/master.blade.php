...
<a href="{{ route('home') }}" class="nav-link active" style="width: 100%">
...
<a href="{{ route('userperformance') }}" class="nav-link" style="">
...
<li class="nav-item menu-open" style="width: 100%;border: " >
<a href="{{ route('payout_monthly_user'), }}" class="nav-link" style="">
<!-- <i class="nav-icon fa-regular fa-chart-mixed"></i> -->
 <i class="nav-icon fa-solid fa-chart-line"></i>
<span class="">Payouts</span>
...
<div class="card">
	<div class="card-header">
		<h2 class="pt-2  ">{{ ucwords(Auth::user()->last_name) }}, {{ ucwords(Auth::user()->first_name) }}</h2>
	</div>
