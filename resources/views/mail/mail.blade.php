...
<form class="jotform-form" action="/sri/sendregmail/send" method="post" name="" id="" accept-charset="utf-8" autocomplete="on">
  {{ csrf_field() }}
    ...
    <ul class="form-section page-section">
      ...
      <li class="form-line" data-type="control_textbox" id="id_3">
        ...
        <div id="cid_3" class="form-input-wide">
          ...
          <input type="text" id="input_3" name="email" data-type="input-textbox" class="form-readonly form-textbox" size="40" value="{{ $data->email }}" tabindex="-1" data-component="textbox" aria-labelledby="label_3" readonly="" />
      ...
      <li class="form-line" data-type="control_textbox" id="id_4">
        ...
        <div id="cid_4" class="form-input-wide">
          <input type="text" id="input_4" name="ccemail" data-type="input-textbox" class="form-textbox" size="40" value="" data-component="textbox" aria-labelledby="label_4" />
        </div>
      </li>
      <li class="form-line" data-type="control_textarea" id="id_5">
        ...
        <div id="cid_5" class="form-input-wide">
          <textarea id="input_5" class="form-textarea" name="q5_email" cols="60" rows="12" data-component="textarea" aria-labelledby="label_5" readonly>You have registered for SRI Investments.SRI Investments&#13&#13 Registration&nbsp&#13&#13Access via - https://www.vincerapisura.com/sedpi-socially-responsible-investment/&#13&#13Your Account is as follows:&#13Username:&#13Password: ****&#13&#13Regards,&#13SRI Investments&#13
          </textarea>
      ...
      <li class="form-line" data-type="control_button" id="id_2">
        <div id="cid_2" class="form-input-wide">
          <div style="margin-left:156px" data-align="auto" class="form-buttons-wrapper  ">
            ...
            @endif
            <a href="/sri/usermail" class="form-submit-button" data-component="button" data-content="">Back</a>
