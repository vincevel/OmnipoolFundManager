...
<form class="jotform-form" action="/sri/usermail" method="post" name="" id="" accept-charset="utf-8" autocomplete="on">
  ...
  <div role="main" class="form-all">
    <ul class="form-section page-section">
      ...
      <li class="form-line form-line-column form-col-1" data-type="control_textbox" id="id_3">
        <label class="form-label form-label-top" id="label_3" for="input_3"> Search for Payout </label>
        <div id="cid_3" class="form-input-wide">
          <span class="form-sub-label-container " style="vertical-align:top">
            <input type="text" id="input_3" name="email" data-type="input-textbox" class="form-textbox" size="40" value="" data-component="textbox" aria-labelledby="label_3 sublabel_input_3" />
  ...
  <!--
    <li class="form-line form-line-column form-col-1" data-type="control_textbox" id="id_3">
        <label class="form-label form-label-top" id="label_3" for="input_3"> Search for Payout2 </label>
        <div id="cid_3" class="form-input-wide">
          <span class="form-sub-label-container " style="vertical-align:top">
            <input type="text" id="input_3" name="email" data-type="input-textbox" class="form-textbox" size="40" value="" data-component="textbox" aria-labelledby="label_3 sublabel_input_3" />
            <label class="form-sub-label" for="input_3" id="sublabel_input_3" style="min-height:13px" aria-hidden="false"> sublabel </label>
 ...
 <!-- form -->
      ...
      @isset($payouts)  
        @if (count($payouts) > 0)
        <label class="form-label form-label-top form-label-auto" id="label_5" for="input_5"> Email User </label>
            ...
            <tbody>
              <tr>
                ...
                <th scope="col" class="form-matrix-column-headers form-matrix-column_0">
                  <label id="label_5_col_0"> 1 </label>
                </th>

                 <th scope="col" class="form-matrix-column-headers form-matrix-column_0">
                  <label id="label_5_col_0"> 2 </label>
                </th>

                 <th scope="col" class="form-matrix-column-headers form-matrix-column_0">
                  <label id="label_5_col_0"> 3 </label>
                </th>

                 <th scope="col" class="form-matrix-column-headers form-matrix-column_0">
                  <label id="label_5_col_0"> 4 </label>
                </th>

                  <th scope="col" class="form-matrix-column-headers form-matrix-column_0">
                  <label id="label_5_col_0"> 5 </label>
                </th>

                  <th scope="col" class="form-matrix-column-headers form-matrix-column_0">
                  <label id="label_5_col_0"> 6 </label>
                </th>

                  <th scope="col" class="form-matrix-column-headers form-matrix-column_0">
                  <label id="label_5_col_0"> 7 </label>
                </th>

                  <th scope="col" class="form-matrix-column-headers form-matrix-column_0">
                  <label id="label_5_col_0"> 8 </label>
                </th>
...
<form class="jotform-form" action="/sri/payouts/{{$payout->id}}" method="post" name="" id="" accept-charset="utf-8" autocomplete="on"> 

 
        {{ csrf_field() }}

              <tr role="group" aria-labelledby="label_5 label_5_row_0">
                <td style="text-align:center" class="form-matrix-values">
                  <label for="input_5_0_0"> {{ $payout->id }} </label>
                </td>
            
                <td style="text-align:center" class="form-matrix-values">
                  <label for="input_5_0_0"> {{ $payout->lastname }} </label>
                </td>
                
                <td style="text-align:center" class="form-matrix-values">
                  <label for="input_5_0_0"> {{ $payout->firstname }} </label>
                </td>
                
                <td style="text-align:center" class="form-matrix-values">
                  <label for="input_5_0_0"> {{ $payout->divpayout }} </label>
                </td>
                
                <td style="text-align:center" class="form-matrix-values">
                  <label for="input_5_0_0"> {{ $payout->contribpayout }} </label>
                </td>
                
                <td style="text-align:center" class="form-matrix-values">
                  <label for="input_5_0_0"> {{ $payout->sribal }} </label>
                </td>
                
                <td style="text-align:center" class="form-matrix-values">
                  <label for="input_5_0_0"> {{ $payout->walletbal }} </label>
                </td>

                <td style="text-align:center" class="form-matrix-values">
                  <label for="input_5_0_0"> {{ $payout->date }} </label>
                </td>
                
                <!--
                <input type="hidden" name="payoutfield" value="{{ $payout }}">
                  
                
                <input type="hidden" name="first_name" value="{{ $payout }}">
                <input type="hidden" name="email" value="{{ $payout }}">
              -->

                <td style="text-align:center" class="form-matrix-values">
                
                
                  <label for="input_5_0_1" >  <button id="input_2" type="submit" class="form-submit-button" data-component="button" data-content="">
              Insert Payout
            </button>  </label>
                <!-- 
                  <label for="input_5_0_1" > 
                    <a href="/payouts/{{ $payout->id }}" class="form-submit-button" data-component="button" data-content="">Insert Payout</a>
