...
<body>
  ...
  @isset ($investmentTypes)
  <div class="container">
    <div class="row">
      <div class="col-4">
         
          <select name="investmentTypes" id="investmentTypes">
    ...
    <div class="row">
      <div class="col-4">Enter Rate: <input type="text" id="rate" name="rate" class="" value=0 placeholder="Enter Rate"></div>
      <div class="col-4"></div>
      <div class="col-4"></div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <div class="col-4">Select Date: <select name="releaseperiod" id="releaseperiod">
          @foreach ($investmentTypes as $investmentType)
            <option value="{{ $investmentType }}">{{ $investmentType }}</option>
          @endforeach
          </select></div>
