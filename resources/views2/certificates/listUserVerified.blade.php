...
<div class="container">
  ...
  <tbody>
    ...
    @isset($transactions)  
        @if (count($transactions) > 0) 
           @foreach ($transactions as $transaction)
            @if ($transaction->investment_type == "MARZAN1" || $transaction->investment_type == "MADDELA1" || $transaction->investment_type == "MARZAN2")
    ...
    @endisset
             ...
             <div class="container">
            <a class="btn btn-xs btn-outline-secondary mt-5" href="/sri/login">Back</a>
          </div>
