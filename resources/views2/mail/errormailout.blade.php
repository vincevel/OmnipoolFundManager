...
<head>
	<meta charset="UTF-8">
	<title>Error: Messenger SRI Investments Deposit</title>
</head>
<body>
...
<BR>  
<p>
ERROR - Your Php{{ $data["amount"] }} deposit on {{ $data["date_transaction"] }} to {{ $data["investment_type"] }} has been registered in the system.
