...
<head>
	<meta charset="UTF-8">
	<title>Pending: SRI Investments Withdraw</title>
</head>
<body>
...
<BR>  
<p>
Your Php{{ $data["amount"] }} withdraw on {{ $data["date_transaction"] }} to {{ $data["investment_type"] }} has been registered in the system.
