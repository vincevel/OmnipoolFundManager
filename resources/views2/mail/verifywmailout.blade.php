...
<head>
	<meta charset="UTF-8">
	<title>Verified: SRI Investments Withdraw</title>
</head>
<body>
Dear {{ $data["requested_by"] }},
<BR>
<BR>  
Your Php{{ $data["amount"] }} withdraw on {{ $data["date_transaction"] }} to {{ $data["investment_type"] }} has been <strong style="color:green">VERIFIED</strong>.
<BR>
<BR>
